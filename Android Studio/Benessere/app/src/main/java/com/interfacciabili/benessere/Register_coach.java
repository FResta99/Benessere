    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        coach_Register_Button.setOnClickListener(new Button.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                EditText etPalestra = (EditText) findViewById(R.id.editTextTextPersonName14);
                String etPalestraTesto = (String) etPalestra.getText().toString();
                if (TextUtils.isEmpty(etPalestraTesto)){
                    etPalestra.setError("Inserire Inidirizzo Studio");
                    errato = true;
                }
                ...
                if (errato == false){
                    ...
                    if (isCoachUsernameInDatabase == true){
                        etUsername.setError("Username già presente");
                    }else {
                        Coach coach = new Coach(etUsernameTesto, etPasswordTesto, etMailTesto, etNomeTesto, etCognomeTesto,
                                Integer.parseInt(etEtaTesto), swSessoTesto, etPalestraTesto);
                        if (databaseService.aggiungiCoach(coach) == true){
