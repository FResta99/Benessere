...
public class InserisciCiboDialog extends AppCompatDialogFragment {
    private EditText etAggiungiCibo;
    private EditText etAggiungiCalorie;
    private Spinner spinnerFascia;
    ...
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.dialog_inserisci_cibo, null);

        etAggiungiCibo = view.findViewById(R.id.etAggiungiCibo);
        etAggiungiCalorie = view.findViewById(R.id.etAggiungiCalorie);
        spinnerFascia = view.findViewById(R.id.spinnerFascia);
        spinnerFascia.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                fascia = (String) parent.getItemAtPosition(position);
            }
        ...
        builder.setView(view)
                .setTitle("Inserisci cibo")
                .setMessage("Scrivi il cibo da inserire")
